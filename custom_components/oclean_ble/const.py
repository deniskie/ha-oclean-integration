...
# Child birthday / user-info command (C3376s.Z / mo5315Z, OcleanBleManager.setUserInfo)
# Payload (4 bytes): sex(0-2), age_clamped(3-18), birth_month(1-12), birth_day(1-31)
# sex: 0=unknown, 1=male, 2=female  (maps to UserTagInfoEntity.getSex())
CMD_SET_BIRTHDAY = bytes.fromhex("0211")
